...
void run_server() { //TODO::make the struct
    ...
    authorization_service authorization_service_;
    lobby_service lobby_service_;
    game_service game_service_;
    builder.AddListeningPort(server_address, grpc::InsecureServerCredentials());
    builder.RegisterService(&authorization_service_);
    builder.RegisterService(&lobby_service_);
    builder.RegisterService(&game_service_);
