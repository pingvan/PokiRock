...
player::player(std::string player_name, const game::player_info *player_info, const int game_enter_balance, grpc::ServerReaderWriter<game::Responses, game::Requests> *stream)
