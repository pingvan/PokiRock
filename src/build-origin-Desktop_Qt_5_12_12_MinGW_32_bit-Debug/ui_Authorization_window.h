...
public:
    ...
    void setupUi(QDialog *authorization_window)
    {
        ...
        sizePolicy1.setHeightForWidth(authorizate->sizePolicy().hasHeightForWidth());
        authorizate->setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(registrate->sizePolicy().hasHeightForWidth());
        registrate->setSizePolicy(sizePolicy2);
